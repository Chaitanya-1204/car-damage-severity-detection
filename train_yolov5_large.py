...
command = (
    ...
    "--data ../data/data.yaml "
    "--weights yolov5l.pt "
    "--name yolov5_large_epochs_200_lr_0.001_ "
    "--optimizer AdamW "
    "--workers 4 "
    "--project ../logs "
    "--patience 7 "
...
command = (
   ...
   "--data ../data/data.yaml "
    "--weights yolov5l.pt "
    "--name yolov5_large_epochs_200_lr_0.0005_ "
    "--optimizer AdamW "
    "--workers 4 "
    "--project ../logs "
    "--patience 7 "
